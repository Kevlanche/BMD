...
public class WaterTower extends PhysicsActor {

	public WaterTower(World world, Island placeOn, float placementX) {
		...
		fd.density = 0.0f;
		fd.filter.categoryBits = Collision.WATERTOWER;
		...
		setSize(scale*Mane.PTM_RATIO, scale*Mane.PTM_RATIO*2);
		setOrigin(0.0f, 0.0f);
